<div class="card-section">
    ...
    <div class="fields-grid">
        ...
        <div class="form-group">
            ...
            <input type="text" name="telefono" value="{{ old('telefono', $user->telefono) }}" class="form-input" placeholder="+593 98 123 4567" required>
            @error('telefono')
                <span class="field-error">{{ $message }}</span>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input type="text" name="direccion" value="{{ old('direccion', $user->direccion) }}" class="form-input" placeholder="Tu direccion">
            @error('direccion')
                <span class="field-error">{{ $message }}</span>
            @enderror
        </div>
