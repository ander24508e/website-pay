...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .page-title { font-size:2.5rem; color:white; margin-bottom:0.3rem; }
        .page-title span { color:var(--red); }
        .page-sub { color:var(--muted); font-size:0.85rem; margin-bottom:2.5rem; }

        /* Alert */
        .alert { padding:0.85rem 1.25rem; border-radius:8px; font-size:0.82rem; font-weight:600; margin-bottom:1.5rem; }
        ...
        @media(max-width:768px){ .carrito-grid { grid-template-columns:1fr; } }

        /* Items */
        .items-card { background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.07); border-radius:12px; overflow:hidden; }
        .items-header { padding:1.25rem 1.5rem; border-bottom:1px solid rgba(255,255,255,0.05); display:flex; align-items:center; justify-content:space-between; }
        .items-header h3 { font-family:'Bebas Neue',sans-serif; font-size:1.2rem; letter-spacing:0.05em; }

        .item-row { display:flex; align-items:center; gap:1.25rem; padding:1.25rem 1.5rem; border-bottom:1px solid rgba(255,255,255,0.04); transition:background 0.2s; }
        .item-row:last-child { border-bottom:none; }
        .item-row:hover { background:rgba(255,255,255,0.02); }

        .item-img { width:56px; height:56px; border-radius:8px; object-fit:cover; flex-shrink:0; background:rgba(255,255,255,0.05); display:flex; align-items:center; justify-content:center; font-size:1.5rem; overflow:hidden; }
        .item-img img { width:100%; height:100%; object-fit:cover; }

        .item-info { flex:1; min-width:0; }
        .item-type { font-size:0.62rem; font-weight:700; letter-spacing:0.15em; text-transform:uppercase; color:var(--gold); margin-bottom:0.2rem; }
        .item-name { font-size:0.9rem; font-weight:600; color:white; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
        .item-unit  { font-size:0.75rem; color:var(--muted); margin-top:0.15rem; }

        .item-qty { display:flex; align-items:center; gap:0.5rem; }
        .qty-btn { width:28px; height:28px; border-radius:6px; border:1px solid rgba(255,255,255,0.1); background:transparent; color:white; cursor:pointer; display:flex; align-items:center; justify-content:center; font-size:0.9rem; transition:all 0.2s; }
        ...
        .item-price { font-family:'Bebas Neue',sans-serif; font-size:1.3rem; color:var(--red); min-width:80px; text-align:right; }
        ...
        .empty-text { color:var(--muted); font-size:0.9rem; margin-bottom:2rem; }

        /* Resumen */
        .resumen-card { background:rgba(255,255,255,0.03); border:1px solid rgba(255,255,255,0.07); border-radius:12px; padding:1.5rem; position:sticky; top:90px; }
        .resumen-title { font-family:'Bebas Neue',sans-serif; font-size:1.3rem; margin-bottom:1.25rem; }
        .resumen-row { display:flex; justify-content:space-between; font-size:0.85rem; color:rgba(255,255,255,0.6); margin-bottom:0.75rem; }
        .resumen-total { display:flex; justify-content:space-between; align-items:center; padding-top:1rem; border-top:1px solid rgba(255,255,255,0.07); margin-top:0.5rem; }
        ...
        .btn-checkout { display:block; width:100%; background:var(--red); color:white; border:none; padding:1rem; border-radius:8px; font-family:'Montserrat',sans-serif; font-weight:700; font-size:0.85rem; letter-spacing:0.1em; text-transform:uppercase; cursor:pointer; transition:all 0.2s; text-align:center; text-decoration:none; margin-top:1.25rem; }
        .btn-checkout:hover { background:var(--red-dark); transform:translateY(-1px); box-shadow:0 8px 20px rgba(216,33,40,0.35); }

        .btn-limpiar { display:block; width:100%; background:transparent; color:var(--muted); border:1px solid rgba(255,255,255,0.08); padding:0.75rem; border-radius:8px; font-family:'Montserrat',sans-serif; font-weight:600; font-size:0.78rem; letter-spacing:0.08em; text-transform:uppercase; cursor:pointer; transition:all 0.2s; text-align:center; margin-top:0.75rem; }
        .btn-limpiar:hover { border-color:rgba(216,33,40,0.4); color:#ff6b6b; }

        .btn-seguir { display:block; text-align:center; color:var(--muted); font-size:0.78rem; margin-top:1rem; text-decoration:none; transition:color 0.2s; }
        .btn-seguir:hover { color:var(--gold); }

        /* Auth notice */
        .auth-notice { background:rgba(240,180,41,0.08); border:1px solid rgba(240,180,41,0.25); border-radius:8px; padding:1rem 1.25rem; font-size:0.8rem; color:var(--gold); margin-top:1rem; text-align:center; }
        ...
        <div class="carrito-grid">
            ...
            <div class="resumen-card">
                ...
                @else
                    ...
                    <a href="{{ route('login') }}" class="btn-checkout" style="margin-top:0.75rem;">
                        Iniciar Sesión
                    </a>
                @endauth
