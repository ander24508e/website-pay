                ...
                <tbody class="divide-y">
                    @forelse ($products as $product)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 sm:px-6 py-3 sm:py-4">
                                @if($product->active)
                                    <span class="bg-green-100 text-green-700 px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                                        Activo
                                    </span>
                                @else
                                    <span class="bg-red-100 text-red-700 px-2 sm:px-3 py-1 rounded-full text-xs font-medium">
                                        Inactivo
                                    </span>
                                @endif
                            </td>
