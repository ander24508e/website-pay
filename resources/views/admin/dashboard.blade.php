        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <article class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <a href="{{ route('admin.ventas.index') }}"
                    class="text-blue-600 text-xs mt-2 inline-flex items-center gap-1 hover:underline">
            ...
            <article class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <a href="{{ route('admin.transactions.index') }}"
                    class="text-emerald-600 text-xs mt-2 inline-flex items-center gap-1 hover:underline">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            @forelse($recentOrders as $order)
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-3">
                                        <span
                                            class="px-2 py-1 rounded-full text-xs font-medium {{ $colors[$order->status] ?? 'bg-gray-100 text-gray-600' }}">{{ ucfirst($order->status) }}</span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-8 text-center text-gray-400 text-sm">No existen
                                        ordenes.</td>
                                </tr>
                            @endforelse
                        </tbody>
