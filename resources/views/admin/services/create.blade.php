...
<div class="container mx-auto px-4 sm:px-6">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-6">
        ...
        <div>
            <h2 class="text-xl sm:text-2xl font-bold text-gray-800">🛠️ Nuevo Servicio</h2>
            <p class="text-gray-400 text-sm">Completa los campos para agregar un servicio al catálogo</p>
        </div>
    </div>
                ...
                <form id="service-form" action="{{ route('admin.services.store') }}" method="POST"
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="4"
                                  ...
                                  placeholder="Describe en qué consiste el servicio...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
