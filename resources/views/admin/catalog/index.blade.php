    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div class="min-w-0">
                ...
                <p class="text-gray-500 text-sm mt-1">Entra a un negocio para crear sus categorias, productos o servicios, y
                    presentaciones.</p>
            </div>
            <a href="{{ route('admin.catalog-types.create') }}"
                ...
                title="Nueva seccion" aria-label="Nueva seccion">
                ...
                @forelse($sections as $section)
                    <article class="p-4">
                        ...
                        <p class="text-sm text-gray-500 mt-3 break-words">
                            {{ $section->description ?: 'Sin descripcion adicional' }}
                        </p>

                        <div class="grid grid-cols-2 gap-3 mt-4">
                            <div class="rounded-lg bg-gray-50 px-3 py-2">
                                <p class="text-[11px] uppercase tracking-wide text-gray-400 font-semibold">Categorias</p>
                                <p class="text-gray-800 font-semibold mt-1">{{ $section->categories_count }}</p>
                            </div>
                            <div class="rounded-lg bg-gray-50 px-3 py-2">
                                <p class="text-[11px] uppercase tracking-wide text-gray-400 font-semibold">Productos/Servicios</p>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-16 text-center">
                                    <div class="max-w-md mx-auto">
                                        <x-heroicon-o-squares-2x2 class="w-12 h-12 text-gray-300 mx-auto mb-4" />
                                        <p class="font-semibold text-gray-700">Todavia no hay secciones.</p>
                                        <p class="text-sm text-gray-400 mt-1 mb-5">Empieza creando una seccion como Carwash,
                                            Bar Cafeteria, Productos o Servicios.</p>
                                        <a href="{{ route('admin.catalog-types.create') }}"
                                            class="inline-flex items-center justify-center rounded-lg bg-gray-900 px-4 py-2.5 text-sm font-semibold text-white hover:bg-gray-700 transition"
                                            title="Nueva seccion" aria-label="Nueva seccion">
                                            <x-heroicon-o-plus class="w-5 h-5" />
