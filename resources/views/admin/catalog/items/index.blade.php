    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        ...
        <form method="GET" action="{{ route('admin.catalog-items.index') }}" class="flex-1 max-w-xl">
            ...
            <div class="relative">
                ...
                <input type="search" name="q" value="{{ request('q') }}" placeholder="Buscar por nombre, sección, categoría o descripcion..." class="w-full rounded-lg border border-gray-200 bg-white py-2.5 pl-10 pr-4 text-sm text-gray-700 placeholder:text-gray-400 focus:border-gray-400 focus:outline-none focus:ring-0">
            </div>
        </form>
