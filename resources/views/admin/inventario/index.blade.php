    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
            <div class="min-w-0">
                ...
                <p class="text-gray-500 text-sm mt-1">Controla tu stock de productos.</p>
            </div>
            @if ($hasProductTypes)
                        ...
                        @forelse($products as $product)
                            ...
                            <div class="rounded-xl border border-gray-100 p-4 space-y-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <span
                                        class="shrink-0 bg-gray-100 text-gray-700 px-2.5 py-1 rounded-full text-xs font-semibold">
                                        Stock: {{ $variantStock }}
                                    </span>
                                </div>
                    ...
                    <div class="hidden md:block overflow-x-hidden">
                        <table class="w-full table-fixed text-sm text-left">
                            ...
                            <tbody class="divide-y">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="px-4 py-8 text-center text-gray-400">No hay productos para
