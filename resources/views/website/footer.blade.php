        ...
        <div class="footer-grid">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-list">
                    ...
                    <li><span></span><div><strong>Sabado</strong><small>{{ $empresa->horario_texto }}</small></div></li>
            ...
            <div class="footer-col">
                <h4>Contacto</h4>
                <ul class="footer-list">
                    <li><span></span><a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer">{{ $empresa->telefono_contacto }}</a></li>
